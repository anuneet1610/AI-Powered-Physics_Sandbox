...
class RigidBody:
    def __init__(self, x, y, vx, vy, mass = 1, can_move=True):
        self.x, self.y = x, y
...
class Ball(RigidBody):
    def __init__(self, x, y, vx, vy, radius, colour, mass = 1, can_move=True):
...
class Rectangle(RigidBody):
    def __init__(self, x, y, vx, vy, length, width, colour, mass=1, can_move=True):
        super().__init__(x, y, vx, vy, mass, can_move)
        self.length = length
        self.width = width
        self.colour = colour
